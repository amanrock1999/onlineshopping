	...
	<tbody>
		<c:forEach items="${prods }" var="p">
			<tr>
				...
				<td><a href="/editprod/${p.prodid}" class="btn btn-danger btn-sm">Edit Product</a></td>
...
<!-- To create product with product details -->
			...
			<form method="POST" enctype="multipart/form-data">
				...
				<div class="modal-body">
					<div class="form-row">
						...
						<div class="col-sm-6">
							<div class="form-group">
								<label>Brand</label> <input type="text" name="company"
									class="form-control">
							</div>
						</div>
					</div>
					<div class="form-row">
						<div class="col-sm-6">
							<div class="form-group">
								<label>Free Delivery Eligible</label> <input type="text" name="salt"
									class="form-control">
							</div>
						</div>
						<div class="col-sm-6">
...
<!-- To update product with new product details -->
